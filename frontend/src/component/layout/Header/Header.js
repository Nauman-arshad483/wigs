          ...
          <Container fluid>
            ...
            <div className="navbar-section">
              <div className="left-section">
                <Navbar.Brand as={Link} to="/Search" className='me-left left-bran'>   <BsSearch /></Navbar.Brand>
              </div>
              <div className="middle-section">
                ...
                >
                  ...
                  <Offcanvas.Body >
                    ...
                    <Nav className='ml-auto div-middle-center-portion'>
              ...
              <div className="right-section">
                <Navbar.Brand as={Link} to="/Search" className='navbar-right'>   <AiOutlineShopping /></Navbar.Brand>
